//====================================
// project7.cpp                                          
// Coders: Jonah Richardson & Lal Ertun
// Tester: Tren Meckel                                              
// Feb 22 2024                                                                  
// project7.cpp                                                                 
// This program reads in a goal weight, the number of weights, and then the values of those weights. It then determines the best combination of
// 	the weights to use in order to get as close to the goal weight as possible. It can use a 1-weight, 2-weight, or 3-weight solution,
//	and automatically determines which is the best.
//====================================
